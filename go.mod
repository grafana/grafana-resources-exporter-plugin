...
require (
	...
	github.com/grafana/grafana/pkg/apimachinery v0.0.0-20250424064802-2fbb2d6f5d27 // indirect
	github.com/grafana/k6-cloud-openapi-client-go v0.0.0-20250416134020-d958828152cd // indirect
