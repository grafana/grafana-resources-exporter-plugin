...
require (
	...
	github.com/grafana/terraform-provider-grafana/v3 v3.13.2
...
require (
	...
	github.com/grafana/amixr-api-go-client v0.0.16 // indirect
	...
	github.com/grafana/synthetic-monitoring-agent v0.29.3 // indirect
